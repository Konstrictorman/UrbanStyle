...
from slider import SliderPanel
...
class SalesForecastApp:
    ...
    def __init__(self):
        ...
        # Initialize trainer
        csv_path = os.path.join(os.path.dirname(__file__), "assets", "Kagle_.csv")
    ...
    def handle_mouse_click(self, pos):
        ...
        # Check button clicks
        if self.train_button.is_clicked(pos):
            self.train_model()
        
        elif self.forecast_button.is_clicked(pos):
